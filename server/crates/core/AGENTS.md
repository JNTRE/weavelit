...
- `weavelit-server-administration/`: Typed, transport-independent Administration Plane action gate, bounded account read/create/reset actions, exact-session-bound authorized account proof, current-session MFA step-up policy, and live component-enablement decision.
