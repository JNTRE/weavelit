...
impl OperationalLogSupport {
    ...
    ///
    /// Recovery supplies only the validated destination module. Fresh event
    /// metadata is generated here, and every construction or delivery failure
    /// is absorbed after at most one System Log delivery attempt.
