...
- `src/lib.rs`: The pre-operational and operational capability declarations this Client Module returns, including authenticated account reads, status changes, MFA-policy step-up and mutations, the compile-time Web UI asset allowlist and its delivery routes, and asset contract tests.
