...
- `src/lib.rs`: The pre-operational and operational capability declarations this Client Module returns, including authenticated account reads and status changes, the compile-time Web UI asset allowlist and its delivery routes, and asset contract tests.
