# Operations CLI macOS Packaging Agent Guide

This directory is reserved for assets that package the versioned Operations CLI
...
- This directory owns macOS `arm64` Operations CLI packaging and installation behavior.
- It does not own Operations CLI source, Server packaging, provider credentials, or Server configuration and initialization.
...
- `AGENTS.md`: Local routing, inventory, and macOS Operations CLI packaging-boundary rules.
...
- Read `../../../docs/roadmap/milestone-8.md` and the Operations CLI requirements before changing macOS release behavior.
