...
- [ ] A supported OCI-compliant production image runs the verified packaged **[Weavelit Server](../../glossary.md#applications-and-interfaces)** artifact without compiling it at container startup.
