...
- `web-ui.md`: Placeholder for Web UI-specific documentation.
...
- Keep Web UI-specific material in `web-ui.md`; move shared client-application material to `../clients.md`.
