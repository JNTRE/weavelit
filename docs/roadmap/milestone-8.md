...
- [ ] A versioned `.deb` package installs the
  **[Weavelit Server](../glossary.md#applications-and-interfaces)**, Web UI
  assets, and Admin CLI on Ubuntu 26.04 LTS `amd64` without requiring Rust,
