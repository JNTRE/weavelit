...
- [ ] Every request entering through the Operations CLI Client Module is
  translated into a validated
  **[Operational Request](../glossary.md#states-and-requests)** for a supported
  **[Operation](../glossary.md#applications-and-interfaces)** and is passed to
  the Server's shared authorization policy.
