...
- [ ] The Zendesk **[Service Module](../glossary.md#applications-and-interfaces)**
  declares one supported
  **[Service Connection](../glossary.md#applications-and-interfaces)** type and
  its setup workflow, and can use a configured connection of that type with
  Zendesk.
- [ ] A Service Connection determines the external Zendesk identity used but
  ...
  must have **[Group](../glossary.md#identities-and-access)** grants to the
  Zendesk Service Module and the named
