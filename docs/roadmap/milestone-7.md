...
- [ ] A **[Human User](../glossary.md#identities-and-access)** can sign in to
  the **[Operations CLI](../glossary.md#applications-and-interfaces)** only when
  a **[Group](../glossary.md#identities-and-access)** grants access to the
...
- [ ] A Human User with Group grants to an enabled
  ...
  **[Service Connection](../glossary.md#applications-and-interfaces)** of that
  Service Module's one supported type is authenticated.
