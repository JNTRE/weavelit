...
- [ ] A **[Human User](../glossary.md#identities-and-access)** can sign in to the **[Weavelit CLI](../glossary.md#applications-and-interfaces)** only when a **[Group](../glossary.md#identities-and-access)** grants access to the Operations CLI **[Client Module](../glossary.md#applications-and-interfaces)**.
- [ ] A Human User can sign out of the Weavelit CLI; subsequent requests are not permitted through the Operations CLI Client Module until the user signs in again.
...
- [ ] An **[Administrator](../glossary.md#identities-and-access)** with Group grants to the Operations CLI Client Module and a named Operation can use the Weavelit CLI, but its **[Server Administration Permission](../glossary.md#identities-and-access)** does not provide Weavelit CLI access or administrative functions through the client.
