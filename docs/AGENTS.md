...
- `project/`: Minimal repository and GitHub Project binding, native issue body
  templates, and deprecated compatibility index that routes legacy references
  to live GitHub and repository authorities without defining planning policy.
