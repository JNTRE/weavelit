...
- It does not own documentation shared by Service Modules; that belongs in `../service-modules.md`.
...
- `zendesk.md`: Placeholder for Zendesk Service Module-specific documentation.
...
- Keep Zendesk-specific material in `zendesk.md`; move shared Service Module material to `../service-modules.md`.
...
- Keep shared provider-integration guidance in `../service-modules.md` and client documentation in `../../clients/`.
