...
- Read the authoritative [GitHub Milestone 8](https://github.com/JNTRE/weavelit/milestone/8) and the Weavelit CLI requirements before changing release-artifact behavior.
